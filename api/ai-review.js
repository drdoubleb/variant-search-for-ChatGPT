...
function buildPrompt(context) {
    ...
    return [
        ...
        '- A variant classified as Pathogenic or Likely Pathogenic must receive a minimum of Tier IIE — never Tier III or Tier IV. Tier III is only appropriate when oncogenicity itself is uncertain (i.e., pathogenicity would be VUS or lower).',
        '- Work down from Tier IA: if any higher tier applies (FDA approval in tumor type → IA; expert consensus → IB; off-label approval or investigational evidence → IIC; preclinical/early-trial evidence → IID), use that tier. Use Tier IIE only after exhausting IA–IID.',
